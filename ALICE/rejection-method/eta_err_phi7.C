...
void draw_err(TH1D* err, TH1D* signal, TH1D* cut_err, TH1D* cut_signal, TH1D* err2, TH1D* signal2, TH1D* cut_err2, TH1D* cut_signal2, TString hist_name, TString hist_pid, TString hist_name2, TString hist_pid2)
{
  ...
  err->GetXaxis()->SetRangeUser(0, 25.5);
  cut_err->GetXaxis()->SetRangeUser(0, 25.5);
  ...
  err2->GetXaxis()->SetRangeUser(0, 25.5);
  cut_err2->GetXaxis()->SetRangeUser(0, 25.5);
  ...
  auto legend1 = new TLegend(0.2, 0.6,0.55,0.7);
  ...
  c->SaveAs("LHC_16_17/PHI7/"+hist_name+" "+hist_name2+".pdf");
...
TCanvas *c2 = new TCanvas(hist_name, hist_name,1200,800);
  ...
  c2->SaveAs("LHC_16_17/PHI7/double_err.pdf");
